...
class Community {
    ...
    constructor(arweave, wallet, cacheTTL = 1000 * 60 * 2) {
        ...
        this.contractSrcTxId = '40tPvYdnGiSpwgnqrS2xJ2dqSvA6h8K11HjJxMs1cbI';
        this.mainContractTxId = 'cEQLlWFkoeFuO7dIsdFbMhsGPvkmRI9cuBxv0mdn0xU';
        this.txFeeUsd = 0.5;
        this.createFeeUsd = 3;
        this.createFee = 0.83;
        this.txFee = 0.21;
    ...
    getFees() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const res = yield redstone_api_1.default.getPrice('AR');
    ...
    createContractFromTx(arweave, wallet, srcTxId, state, tags = [], target = '', winstonQty = '', reward) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof contractTX.sign === 'function') {
                response = yield contractTX.signAndPost(0);
            }
            else {
                yield arweave.transactions.sign(contractTX, wallet);
                response = yield arweave.transactions.post(contractTX);
            }
