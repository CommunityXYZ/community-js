...
class Community {
    ...
    constructor(arweave, wallet, cacheRefreshInterval = (1000 * 60 * 2)) {
        this.contractSrc = '2QYcBH4omIYNgri2jOdVmVxR9oPSOqVyhR6xbPmTidI';
        this.mainContract = 'FcM-QQpfcD0xTTzr8u4Su9QCgcvRx_JH4JSCQoFi6Ck';
    ...
    selectWeightedHolder(balances = this.state.balances, vault = this.state.vault) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const fn = (balances, vault) => __awaiter(this, void 0, void 0, function* () {
                let totalTokens = 0;
