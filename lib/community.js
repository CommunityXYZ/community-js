(function (factory) {
    ...
    var redstone_api_1 = tslib_1.__importDefault(require("redstone-api"));
            ...
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 2:
                            tags = tslib_1.__spreadArray.apply(void 0, [tslib_1.__spreadArray.apply(void 0, _b.concat([(_c.sent())])), [
                            ...
                            return [4 /*yield*/, smartweave_1.createContractFromTx(this.arweave, this.wallet, this.contractSrc, JSON.stringify(toSubmit), tags, target, winstonQty)];
                        case 3:
                            communityID = _c.sent();
                ...
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            _b.label = 2;
                        case 2: return [2 /*return*/, smartweave_1.interactRead(this.arweave, this.wallet || this.dummyWallet, this.communityContract, params)];
                    }
                });
            });
        };
            ...
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, redstone_api_1.default.getPrice('AR')];
                        case 1:
                            price = _a.sent();
                ...
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.cleanTags(tags)];
                        case 1:
                            tags = tslib_1.__spreadArray.apply(void 0, [tslib_1.__spreadArray.apply(void 0, _a.concat([(_b.sent())])), [
                ...
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            input = tslib_1.__assign(tslib_1.__assign({}, pCopy), { function: 'propose' });
                            _a = [[]];
                            return [4 /*yield*/, this.cleanTags(tags)];
                        case 1:
                            tags = tslib_1.__spreadArray.apply(void 0, [tslib_1.__spreadArray.apply(void 0, _a.concat([(_b.sent())])), [
            ...
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.trys.push([2, 4, , 6]);
                            return [4 /*yield*/, axios_1.default(this.cacheServer + "contract/" + this.mainContract)];
                        case 3:
                            state = (_a.sent()).data;
                            return [3 /*break*/, 6];
                        case 4:
                            _a.sent();
                            return [4 /*yield*/, smartweave_1.readContract(this.arweave, this.mainContract)];
                        case 5:
                            state = _a.sent();
                            return [3 /*break*/, 6];
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if (this.stateCallInProgress) {
                                getLastState_1 = function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                    return tslib_1.__generator(this, function (_a) {
                                        if (this.stateCallInProgress) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 5]);
                            return [4 /*yield*/, axios_1.default(this.cacheServer + "contract/" + this.communityContract)];
                        case 2:
                            state = (_a.sent()).data;
                            return [3 /*break*/, 5];
                        case 3:
                            _a.sent();
                            return [4 /*yield*/, smartweave_1.readContract(this.arweave, this.communityContract)];
                        case 4:
                            state = _a.sent();
                            return [3 /*break*/, 5];
                        case 5:
                ...
                return tslib_1.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, smartweave_1.interactWriteDryRun(this.arweave, this.wallet || 'use_wallet', this.communityContract, input, tags, target, winstonQty)];
                        case 2:
                            res = _b.sent();
                            if (res.type === 'error') {
                                //  || res.type === 'exception'
                            ...
                            return [2 /*return*/, smartweave_1.interactWrite(this.arweave, this.wallet || 'use_wallet', this.communityContract, input, tags, target, winstonQty)];
                    }
                });
            });
        };
