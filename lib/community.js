...
class Community {
     ...
     */
    constructor(arweave, wallet, useArweaveGw = false) {
        ...
        if (typeof window !== 'object') {
            if (useArweaveGw) {
                ...
                this.warp = warp_contracts_1.WarpNodeFactory.memCachedBased(this.arweave).useArweaveGateway().build();
            }
            else {
                this.warp = warp_contracts_1.WarpNodeFactory.memCachedBased(this.arweave).build();
            }
        }
        else {
            if (useArweaveGw) {
                ...
                this.warp = warp_contracts_1.WarpWebFactory.memCachedBased(this.arweave).build();
            }
        }
        this.getFees();
        this.events();
    ...
    create(tags = []) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { contractTxId: communityID } = yield this.warp.createContract.deployFromSourceTx({
    ...
    chargeFee() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                console.log(e);
                try {
                    ({ state } = yield this.warp.contract(this.mainContract).readState());
                }
                catch (e) {
                    console.log(e);
                    return {
    ...
    update() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                console.log(e);
                try {
                    ({ state } = yield this.warp.contract(this.communityContract).readState());
                }
                catch (e) {
                    console.log(e);
                    return;
