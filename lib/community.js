...
class Community {
    ...
    getState(cached = true) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!cached || ((new Date()).getTime() - this.lastStateCall) > this.cacheRefreshInterval) {
                ...
                if (!this.state) {
                    // @ts-ignore
                    this.state = yield smartweave_1.readContract(this.arweave, this.communityContract);
                    this.lastStateCall = (new Date()).getTime();
                    this.stateCallInProgress = false;
                }
                // @ts-ignore
                smartweave_1.readContract(this.arweave, this.communityContract).then(state => {
                    this.state = state;
                    this.lastStateCall = (new Date()).getTime();
                    this.stateCallInProgress = false;
                }).catch((e) => {
    ...
    create() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // @ts-ignore
            const communityID = yield smartweave_1.createContractFromTx(this.arweave, this.wallet, this.contractSrc, JSON.stringify(this.state));
    ...
    get(params = { function: 'balance' }) {
        return __awaiter(this, void 0, void 0, function* () {
            // @ts-ignore
            return smartweave_1.interactRead(this.arweave, this.wallet, this.communityContract, params);
        });
    }
    /**
