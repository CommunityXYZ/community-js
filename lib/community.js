...
class Community {
  ...
  create(tags = []) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const communityID = yield smartweave_1.createContractFromTx(
        this.arweave,
    ...
    return __awaiter(this, void 0, void 0, function* () {
      tags = [
        ...
        ...[
          ...
          {
            name: 'Message',
            value: `Transfer locked to ${target} of ${utils_1.default.formatNumber(
              qty,
            )} for ${utils_1.default.formatNumber(lockLength)} blocks.`,
          },
          { name: 'Community-ID', value: this.communityContract },
          { name: 'Service', value: 'CommunityXYZ' },
        ],
    ...
    return __awaiter(this, void 0, void 0, function* () {
      tags = [
        ...
        ...[
          ...
          {
            name: 'Message',
            value: `Locked ${utils_1.default.formatNumber(qty)} for ${utils_1.default.formatNumber(
              lockLength,
            )} blocks (${utils_1.default.formatBlocks(lockLength)}).`,
          },
          { name: 'Community-ID', value: this.communityContract },
          { name: 'Service', value: 'CommunityXYZ' },
        ],
    ...
    return __awaiter(this, void 0, void 0, function* () {
      tags = [
        ...
        ...[
          ...
          {
            name: 'Message',
            value: `Increased vault ID ${vaultId} for ${lockLength} blocks (${utils_1.default.formatBlocks(
              lockLength,
            )}).`,
          },
          { name: 'Community-ID', value: this.communityContract },
  ...
  chargeFee() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      let state;
      try {
        state = (yield axios_1.get(`${this.cacheServer}contract/${this.mainContract}`)).data;
      } catch (e) {
        try {
  ...
  update() {
    return __awaiter(this, void 0, void 0, function* () {
      let state;
      try {
        state = (yield axios_1.get(`${this.cacheServer}contract/${this.communityContract}`)).data;
      } catch (e) {
        try {
  ...
  interact(input, tags = []) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const res = yield smartweave_1.interactWriteDryRun(
        this.arweave,
        this.wallet || 'use_wallet',
        this.communityContract,
        input,
      ...
      return smartweave_1.interactWrite(
        this.arweave,
        this.wallet || 'use_wallet',
        this.communityContract,
        input,
