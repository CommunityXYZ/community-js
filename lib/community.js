...
class Community {
    ...
    create(tags = []) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const communityID = yield smartweave_1.createContractFromTx(this.arweave, this.wallet || 'use_wallet', this.contractSrc, JSON.stringify(toSubmit), tags, target, winstonQty);
