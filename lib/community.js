...
class Community {
    ...
    constructor(arweave, wallet, cacheRefreshInterval = 1000 * 60 * 2) {
        ...
        this.limestoneDeployerAddy = 'R9PL9jt-mZoV6XcNjJD2uB2ajiFTC7PYZ_iyySzzz6U';
        this.checkCoingeckoAfter = 60 * 60 * 24 * 1000; // 24 hours
    ...
    create(tags = []) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const fee = yield this.chargeFee(this.createFee);
            const target = fee.target;
            const winstonQty = fee.winstonQty;
            ...
            const communityID = yield smartweave_1.createContractFromTx(this.arweave, this.wallet, this.contractSrc, JSON.stringify(toSubmit), tags, target, winstonQty);
    ...
    getFees() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const res = yield axios_1.default('https://api.coingecko.com/api/v3/simple/price?ids=arweave&vs_currencies=usd&include_last_updated_at=true');
    ...
    chargeFee(fee = this.txFee) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let state;
            try {
                state = (yield axios_1.default(`${this.cacheServer}contract/${this.mainContract}`)).data;
            }
            catch (e) {
                state = yield smartweave_1.readContract(this.arweave, this.mainContract);
            }
    ...
    update(recall = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let state;
            try {
                state = (yield axios_1.default(`${this.cacheServer}contract/${this.communityContract}`)).data;
            }
            catch (e) {
                state = yield smartweave_1.readContract(this.arweave, this.communityContract);
            }
    ...
    interact(input, tags, fee = this.txFee) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield smartweave_1.interactWriteDryRun(this.arweave, this.wallet || 'use_wallet', this.communityContract, input, tags, target, winstonQty);
            if (res.type === 'error') {
                //  || res.type === 'exception'
