...
class Community {
    ...
    interact(input, tags, fee = this.txFee) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield smartweave_1.interactWriteDryRun(this.arweave, this.wallet, this.communityContract, input, tags, target, winstonQty);
            if (res.type === 'error') {
                //  || res.type === 'exception'
                throw new Error(res.result);
            }
            return smartweave_1.interactWrite(this.arweave, this.wallet, this.communityContract, input, tags, target, winstonQty);
        });
    }
}
