...
const dist_src_1 = require("smartweave/dist-src");
...
class Community {
    ...
    create() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // @ts-ignore
            const communityID = yield dist_src_1.createContractFromTx(this.arweave, this.wallet, this.contractSrc, JSON.stringify(toSubmit));
    ...
    get(params = { function: 'balance' }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // @ts-ignore
            return dist_src_1.interactRead(this.arweave, this.wallet || this.dummyWallet, this.communityContract, params);
        });
    }
    /**
    ...
    chargeFee(action, bytes = this.txFee) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // @ts-ignore
            const target = yield dist_src_1.readContract(this.arweave, this.mainContract).then((state) => {
    ...
    update(recall = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // @ts-ignore
            const res = yield dist_src_1.readContract(this.arweave, this.communityContract);
    ...
    interact(input) {
        return __awaiter(this, void 0, void 0, function* () {
            // @ts-ignore
            const res = yield dist_src_1.interactWriteDryRun(this.arweave, this.wallet, this.communityContract, input);
            if (res.type === 'error') {
                //  || res.type === 'exception'
                throw new Error(res.result);
            }
            // @ts-ignore
            return dist_src_1.interactWrite(this.arweave, this.wallet, this.communityContract, input);
        });
    }
}
