...
class DAOGarden {
    ...
    constructor(arweave, wallet, cacheRefreshInterval = (1000 * 60 * 2)) {
        this.srcTxId = '3JnnzXKiWctcu4_5OJoUZ21fn21MTqbESwX6cixhpb4';
        this.mainContract = 'BAfcKVhykkup_onxxgzj3T0fMhp33bY82OK23Rruy-Q';
    ...
    create() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // @ts-ignore
            const daoID = yield smartweave_1.createContractFromTx(this.arweave, this.wallet, this.srcTxId, JSON.stringify(this.state));
    ...
    proposeVote(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const input = Object.assign({ function: 'propose' }, params);
