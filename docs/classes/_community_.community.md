...
> [Globals](../README.md) / ["community"](../modules/_community_.md) / Community
...
`options?` | { decimals: number ; formatted: boolean ; trim: boolean  } | - | If return inAr is set to true, these options are used to format the returned AR value.  |
